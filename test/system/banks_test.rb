...
class BanksTest < ApplicationSystemTestCase
  ...
  test "should create bank" do
    ...
    fill_in "Mfo", with: @bank.mfo
    fill_in "Name and rquesit bank", with: @bank.name_and_rquesit_bank
    fill_in "Number caunt bank", with: @bank.number_caunt_bank
    fill_in "Oue organization", with: @bank.oue_organization_id
